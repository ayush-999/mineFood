                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="<?php echo $imagePath; ?>" alt="Admin" class="mainProfileImg">
                                <div class="mt-3">
                                    <h5><?php echo $adminDetails['name']; ?></h5>
                        ...
                        <div class="col-md-7">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="<?php echo $adminDetails['name']; ?>"
                                        disabled>
                                </div>
                            </div>
                            <hr>
